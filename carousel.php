...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Carousel Template &middot; Twittstrap</title>
...
<?php include 'include/docs-nav.php'; ?>
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item active">
          <img src="/booted-beta/assets/img/examples/slide-01.jpg" alt="">
          <div class="container">
        ...
        <div class="item">
          <img src="/booted-beta/assets/img/examples/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img src="/booted-beta/assets/img/examples/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="/booted-beta/assets/img/examples/browser-icon-chrome.png">
      ...
      <div class="featurette">
        <img class="featurette-image pull-left" src="/booted-beta/assets/img/examples/browser-icon-firefox.png">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="/booted-beta/assets/img/examples/browser-icon-safari.png">
