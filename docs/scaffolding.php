...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Scaffolding · Twittstrap</title>
...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>Scaffolding</h1>
    <p class="lead">Booted is built on responsive 12-column grids, layouts, and components.</p>
  </div>
</header>
...
&lt;link href="/booted-beta/assets/css/bootstrap-responsive.css" rel="stylesheet"&gt;
          ...
          <img src="/booted-beta/assets/img/responsive-illustrations.png" alt="Responsive devices" style="float: right; margin: 0 0 20px 20px;">
