...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Select Box - Bootstrap Form Helpers</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Extend Bootstrap's components with custom select boxes.">
    <meta name="keywords" content="jquery,jquery plugins,twitter bootstrap,bootstrap form,bootstrap form helpers,select box,selectbox,select input,select">
