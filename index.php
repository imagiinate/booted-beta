...
<div class="jumbotron masthead">
  <div class="container">
    ...
    <ul class="masthead-links">
      <li>
        <a href="https://github.com/imagiinate/booted-beta">GitHub project</a>
      </li>
      <li>
        <a href="#">Examples</a>
      </li>
...
<div class="bs-docs-social">
  ...
  <div class="marketing">
    ...
    <h1>Introducing Booted.</h1>
    <p class="marketing-byline">Need reasons to love Booted? Look no further.</p>

    <div class="row-fluid">
      <div class="span4">
        <img class="marketing-img" <img src="/booted-beta/assets/img/bs-docs-twitter-github.png">
        <h2>By nerds, for nerds.</h2>
        <p>Built at Twitter by <a href="http://twitter.com/mdo">@mdo</a> and <a href="http://twitter.com/fat">@fat</a>, Bootstrap utilizes <a href="http://lesscss.org">LESS CSS</a>, is compiled via <a href="http://nodejs.org">Node</a>, and is managed through <a href="http://github.com">GitHub</a> to help nerds do awesome stuff on the web.</p>
      </div>
      <div class="span4">
        <img class="marketing-img" <img src="/booted-beta/assets/img/bs-docs-responsive-illustrations.png">
        <h2>Made for everyone.</h2>
        <p>Bootstrap was made to not only look and behave great in the latest desktop browsers (as well as IE7!), but in tablet and smartphone browsers via <a href="/booted-beta/docs/scaffolding.php#responsive">responsive CSS</a> as well.</p>
      </div>
      <div class="span4">
        <img class="marketing-img" <img src="/booted-beta/assets/img/bs-docs-bootstrap-features.png">
        <h2>Packed with features.</h2>
        <p>A 12-column responsive <a href="/booted-beta/docs/scaffolding.php#gridSystem">grid</a>, dozens of components, <a href="/booted-beta/docs/javascript.php">JavaScript plugins</a>, typography, form controls, and even a <a href="/booted-beta/docs/customize.php">web-based Customizer</a> to make Bootstrap your own.</p>
      </div>
    </div>
      ...
      <ul class="thumbnails example-sites">
        <li class="span3">
          <a class="thumbnail" href="http://soundready.fm/" target="_blank">
            <img <img src="/booted-beta/assets/img/example-sites/soundready.png" alt="SoundReady.fm">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://kippt.com/" target="_blank">
            <img <img src="/booted-beta/assets/img/example-sites/kippt.png" alt="Kippt">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://www.gathercontent.com/" target="_blank">
            <img <img src="/booted-beta/assets/img/example-sites/gathercontent.png" alt="Gather Content">
          </a>
        </li>
        <li class="span3">
          <a class="thumbnail" href="http://www.jshint.com/" target="_blank">
            <img <img src="/booted-beta/assets/img/example-sites/jshint.png" alt="JS Hint">
          </a>
        </li>
      </ul>
     </div>
    ...
    <p class="marketing-byline">These are modified versions of the templates that come included, (don't worry, they are still untouched in the docs)</p>
    <div class="row-fluid">
     	<ul class="thumbnails bootstrap-examples">
            <li class="span3">
              <a class="thumbnail" href="starter-template.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="hero.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="fluid.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="marketing-narrow.php">
          ...
          <ul class="thumbnails bootstrap-examples">
          	<li class="span3">
              <a class="thumbnail" href="justified-nav.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="signin.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="sticky-footer.php">
            ...
            <li class="span3">
              <a class="thumbnail" href="carousel.php">
